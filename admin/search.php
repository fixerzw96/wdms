...
<html>
<head>
<title>Water Distribution Management System | Search Orders</title>
...
<h3>Search Order</h3>
    ...
    echo $msg;
								...
								<div class="form-group">
									<label for="smallinput" class="col-sm-2 control-label label-input-sm">Search by Order Number:</label>
									<div class="col-sm-8">
