...
<div class="super_container">
	...
	<div class="home">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/waterislife.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
				...
				<div class="col-lg-4">
					...
					<div class="listing">
						...
						<div class="listing_image">
							...
							<div class="tag_price listing_price"><?php echo $row['CompanyName'];?> <?php echo $row['BottleSize'];?> at   Rmb. <?php echo $row['Price'];?></div>
						</div>
